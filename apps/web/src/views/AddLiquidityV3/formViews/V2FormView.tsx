...
import { alignItems, flex } from 'styled-system'
...
export default function V2FormView({
  ...
  // console.log('currencyAAA:', currencies[Field.CURRENCY_A].symbol)
  ...
  return (
    <>
      <AutoColumn>
          ...
          {currencies[Field.CURRENCY_B] && (
            ...
            >
              <div style={{ display: 'flex', flexFlow: 'column', alignItems: 'center' }}>
                ...
                <span>
                  {currencies[Field.CURRENCY_A] ? currencies[Field.CURRENCY_A].symbol : '-'} per{' '}
              ...
              <div style={{ display: 'flex', flexFlow: 'column', alignItems: 'center' }}>
                ...
                <span>
                  {currencies[Field.CURRENCY_B] ? currencies[Field.CURRENCY_B].symbol : '-'} per{' '}
        ...
        <MediumOnly style={{ marginTop: '16px' }}>{buttons}</MediumOnly>
      </AutoColumn>

      ...
      {chains
        .filter(
          (chain) =>
            ...
            chain.id === ChainId.BASE_TESTNET || chain.id === ChainId.BASE_MAINNET,
          // chain.id === ChainId.BASE_TESTNET || !('testnet' in chain && chain.testnet) || chain.id === chainId,
        )
        .map((chain) => (
          <>
            <UserMenuItem
...
const SHORT_SYMBOL = {
  ...
  [ChainId.BASE_TESTNET]: 'baseETH',
  // [ChainId.BASE_MAINNET]: 'baseMain',
